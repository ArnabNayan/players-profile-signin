...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-slate-400 mt-10 text-primary-content">
        <div>
          ...
          <p className="font-bold text-3xl">
           Players Profile and Performence. <br/>Providing fitness players since 2023
          </p> 
